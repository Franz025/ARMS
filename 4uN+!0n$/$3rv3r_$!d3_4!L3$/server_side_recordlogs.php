...
if ($ushertayp == 1 || $ushertayp == 2 || $ushertayp == 3) {
    ...
    $columns = array(
        ...
        array('db' => 'controlnum', 'dt' => 2),
        array('db' => 'app_status', 'dt' => 3),
        array('db' => 'date_interview', 'dt' => 4),
        array('db' => 'interviewed_by', 'dt' => 5),
        array('db' => 'controlnum_renew', 'dt' => 6),
        array('db' => 'app_status2', 'dt' => 7),
        array('db' => 'approved_by', 'dt' => 8),
        array('db' => 'date_approved', 'dt' => 9),
