...
if ($ushertayp == 1 || $ushertayp == 2 || $ushertayp == 3) {
    ...
    $app_status2 = ['RENEWAL', 'PENDING'];

    $table = "
        (
            SELECT tbl_pmcis.*, tbl_users.fullname 
            FROM tbl_pmcis 
            INNER JOIN tbl_users 
            ON tbl_users.codename = tbl_pmcis.interviewed_by 
            WHERE app_status2 IN ('" . implode("', '", $app_status2) . "')
        ) temp";
        ...
        $columns = array(
            ...
            array('db' => 'controlnum', 'dt' => 1),
            array('db' => 'g_firstname', 'dt' => 2),
            array('db' => 'g_middlename', 'dt' => 3),
            array('db' => 'g_lastname', 'dt' => 4),
            array('db' => 'g_bday', 'dt' => 5),
            array('db' => 'g_age', 'dt' => 6),     
            array('db' => 'g_status', 'dt' => 7),
            array('db' => 'g_province', 'dt' => 8),
            array('db' => 'g_muni_city', 'dt' => 9),
            array('db' => 'g_barangay', 'dt' => 10),
            array('db' => 'g_address', 'dt' => 11),
            array('db' => 'g_educ_attained', 'dt' => 12),
            array('db' => 'g_occupation', 'dt' => 13),
            array('db' => 'g_contactnum', 'dt' => 14),
            array('db' => 'g_foreign_partner', 'dt' => 15),
            array('db' => 'g_fathername', 'dt' => 16),
            array('db' => 'g_mothername', 'dt' => 17),
            array('db' => 'g_1D', 'dt' => 18),
            array('db' => 'g_2D', 'dt' => 19),
            array('db' => 'g_3D', 'dt' => 20),
            array('db' => 'g_4D', 'dt' => 21),
    
            array('db' => 'b_firstname', 'dt' => 22),
            array('db' => 'b_middlename', 'dt' => 23),
            array('db' => 'b_lastname', 'dt' => 24),
            array('db' => 'b_bday', 'dt' => 25),
            array('db' => 'b_age', 'dt' => 26),
            array('db' => 'b_status', 'dt' => 27),
            array('db' => 'b_province', 'dt' => 28),
            array('db' => 'b_muni_city', 'dt' => 29),
            array('db' => 'b_barangay', 'dt' => 30),
            array('db' => 'b_address', 'dt' => 31),
            array('db' => 'b_educ_attained', 'dt' => 32),
            array('db' => 'b_occupation', 'dt' => 33),
            array('db' => 'b_contactnum', 'dt' => 34),
            array('db' => 'b_foreign_partner', 'dt' => 35),
            array('db' => 'b_fathername', 'dt' => 36),
            array('db' => 'b_mothername', 'dt' => 37),
            array('db' => 'b_1D', 'dt' => 38),
            array('db' => 'b_2D', 'dt' => 39),
            array('db' => 'b_3D', 'dt' => 40),
            array('db' => 'b_4D', 'dt' => 41),
    
            array('db' => 'l_engagement', 'dt' => 42),
            array('db' => 'num_children', 'dt' => 43),
            array('db' => 'date_proposal', 'dt' => 44),
            array('db' => 'date_marriage', 'dt' => 45),
            array('db' => 'lmp', 'dt' => 46),
            array('db' => 'pmc_sched', 'dt' => 47),
            array('db' => 'date_interview', 'dt' => 48),
            array('db' => 'interviewed_by', 'dt' => 49),
            array('db' => 'or_number', 'dt' => 50),
            array('db' => 'TM1', 'dt' => 51),
            array('db' => 'TM2', 'dt' => 52),
            array('db' => 'TM3', 'dt' => 53),
            array('db' => 'app_status', 'dt' => 54),
            array('db' => 'app_status2', 'dt' => 55),
            array('db' => 'controlnum_renew', 'dt' => 56),
            array('db' => 'updated_at', 'dt' => 57),
            array('db' => 'or_number_renew', 'dt' => 58),
            array('db' => 'TM1_renew', 'dt' => 59),
            array('db' => 'TM2_renew', 'dt' => 60),
            array('db' => 'TM3_renew', 'dt' => 61),
            array('db' => 'approved_by', 'dt' => 62),
            array('db' => 'date_approved', 'dt' => 63),
            array('db' => 'remarks', 'dt' => 64),
            array('db' => 'turnaround_time', 'dt' => 65),
            array('db' => 'action_type', 'dt' => 66),
            array('db' => 'released_status', 'dt' => 66),
            array('db' => 'released_status2', 'dt' => 67),
            array('db' => 'fullname', 'dt' => 68),
