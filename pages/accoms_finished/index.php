...
<div class="container-fluid">
    <div class="card card-outline card-success">
        <div class="card-header">
            <h6 class="card-title" style="font-weight: bold; font-size: 15px;"><i class="nav-icon fas fa-check-square"></i>
                &nbsp;
                Finished System Requests </h6>
        ...
        <div class="modal-content">
            <div class="modal-header justify-content-between bg-success text-center">
                ...
                <div class="modal-actions">
                    <!-- <button type="button" class="btn btn-warning" id="enableEdit" aria-label="Enable editing for the task">
                        <i class="fas fa-save"></i> <b> Update </b>
                    </button> -->
            ...
            <div class="modal-body">
                <form id="updateUser">
                    ...
                    <input type="hidden" name="progs_status" id="progs_status" value="">
                    ...
                    <div class="card card-outline card-success" style="padding: 20px; margin: 10px;">
                        <div class="row d-flex justify-content-between">
                            <div class="col-md-4">
                                ...
                                <span class="badge badge-success" style="font-size: 15px;"><b>FINISHED</b></span>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select class="form-control select" name="services" id="servicesField" autocomplete="off" required disabled>
                            ...
                            <div class="col-md-9">
                                ...
                                <select class="form-control select" name="offices" id="officesField" autocomplete="off" required disabled>
                                    <option selected="" disabled="" value="">Please select...</option>
                                    <?php
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="accoms_descField" name="accoms_desc" autocomplete="off" style="height: 100px;" readonly required></textarea>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="tech_remarksField" name="tech_remarks" autocomplete="off" style="height: 100px;" readonly required></textarea>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row d-flex justify-content-end">
                            <div class="col-md-8">
                                ...
                                <input type="datetime-local" class="form-control" value="<?php echo date('Y-m-d H:i:s') ?>" id="date_startedField" name="date_started" readonly required>
                            </div>
                            <div class="col-md-4">
                                <label for="user_idField" class="form-label"><b> Personnel Name: </b></label>
                                <input type="text" class="form-control" value="<?php echo $_SESSION["fullname"] ?>" id="user_idField" name="user_id" autocomplete="off" readonly required>
                            </div>
                        </div>
                    </div>
            </div>
            ...
            <div class="modal-footer">
                <!-- <button type="button" class="btn btn-success" id="submitBtn" disabled>Submit</button>
                <button type="button" class="btn btn-success" id="finishedBtn" disabled>Finished</button> -->
            </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#example').DataTable({
            ...
            responsive: true,
            ajax: {
                url: '../4uN+!0n$/$3rv3r_$!d3_4!L3$/server_side_accoms_finished.php',
            },
            columns: [{
                    "data": 1,
    ...
    $(document).on('submit', '#addUser', function(e) {
        ...
        if (tracknumber !== '' && services !== '' && offices !== '' && accoms_desc !== '' && user_id !== '' && progs_status !== '' && date_started !== '' && tech_remarks !== '') {
    ...
    document.getElementById('enableEdit').addEventListener('click', function() {
        ...
        form.querySelectorAll('input[readonly], select[disabled], textarea[readonly]').forEach(function(element) {
            if (element.id !== 'date_startedField' && element.id !== 'user_idField' && element.id !== 'tracknumberField' && element.id !== 'tech_remarks') {
    ...
    $(document).on('submit', '#updateUser', function(e) {
        ...
        var services = $('#servicesField').val();
        var offices = $('#officesField').val();
        var accoms_desc = $('#accoms_descField').val();
        var tech_remarks = $('#tech_remarksField').val();
        var user_id = $('#user_idField').val();
        var progs_status = 'FINISHED';
        var date_started = $('#date_startedField').val();
        var id = $('#id').val();

        if (tracknumber && services && accoms_desc && user_id && date_started && tech_remarks) {
