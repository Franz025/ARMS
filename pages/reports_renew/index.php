...
<div class="container-fluid">
    <div class="card card-outline card-success">
        <div class="card-header">
            <h3 class="card-title" style="font-weight: bold; font-size: 18px;"><i class="fas fa-file-contract"></i> &nbsp; Renewal Report Sheet </h3>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#example').DataTable({
            ...
            responsive: true,
            ajax: {
                url: '../4uN+!0n$/$3rv3r_$!d3_4!L3$/server_side_reports_renew.php',
            },
            columns: [{
                    "data": 50,
                ...
                $('#example tbody').on('click', 'a.editbtn', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#TM1_renewField').text(json.TM1_renewname);
                            $('#TM2_renewField').text(json.TM2_renewname);
                            $('#TM3_renewField').text(json.TM3_renewname);

                            $('#TM_1renewField').text(json.TM1_renewpos);
                            $('#TM_2renewField').text(json.TM2_renewpos);
                            $('#TM_3renewField').text(json.TM3_renewpos);
